...
{
    public class DefenceUnitUIButton : MonoBehaviour
    {
        ...
        public void Init(UnitInfo<DefenceUnit> defenceItem, int howManyDefenceItems)
        {
            ...
            _defencerCountTxt.text = "x" + _howManyDefenceItems;
        }

        private void OnEnable()
        {
            _button?.onClick.AddListener(OnButtonClick);
            _onDefenceItemSelected.onEventRaised += OnDefenceItemSelected;
        ...
        private void OnDefenceItemSelected(Unit unit)
        { 
            if (unit == _defenceUnit.Unit) return; 
