...
namespace _Project._Scripts.Initilazer
{
    ...
    { 
        ...
        { 
            ...
            var playerLineSetupCommand = new PlayerLinePositioner(
                _playerLine,
                boardSetupCommand
            ); 
            var enemySpawnerSetupCommand = new EnemySpawnerInitializer(
                _enemySpawner,
                _levelManager,
                boardSetupCommand
            ); 
            var defenceItemUIBuilderCommand = new DefenceUIBuilder(
